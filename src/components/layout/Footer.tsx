  ...
  return (
    <footer className="border-t mt-16">
      <div className="container py-10 grid gap-6 md:grid-cols-3">
        <div>
          <h3 className="font-heading text-lg mb-2">TechSavvy Finds</h3>
        ...
        <nav className="space-y-2">
          ...
          <a className="story-link block" href="#contacto">Contacto</a>
        </nav>
        <div className="text-sm text-muted-foreground md:text-right">© {year} TechSavvy Finds. Todos los derechos reservados.</div>
      </div>
    </footer>
  );
};
